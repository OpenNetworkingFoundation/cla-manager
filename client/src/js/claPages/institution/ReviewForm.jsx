    ...
    <>
      <div id='institutional-cla'>
        ...
        <p style={{ textAlign: 'center' }}><b>Open Networking Foundation</b>
          <br />
          <b>Institutional Contributor License Agreement ("Agreement")</b>
        </p>
        ...
        distributed by ONF, You reserve all right, title, and interest in and to Your Contributions.
        </p>
        ...
        designate via written notice to ONF, each have the power and authority to
        modify <b><u>Schedule A</u></b> by providing written notice of such modification
        to ONF.&nbsp; Notice of any change to Your Primary Contact, Alternate Contact,
        or <b><u>Schedule A</u></b> may be provided via e-mail message by Your then-current Primary
        Contact or Alternate Contact, and does not need to be in the form of a signed
        amendment to this Agreement to be binding upon the parties.
        </p>
        ...
        or to the Institution's Primary Contact or Alternate Contact.
        </p>
        ...
        supersede and replace all such prior agreements.
        </p>
